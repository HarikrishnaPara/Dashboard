...
public class FunctionalLibrary 
{
	...
	public static void typeAction(WebDriver driver, String Locator_Name, String Locator_Value, String Data) {
	{
		if(Locator_Name.equalsIgnoreCase("xpath")) {
		{
		...
		else if(Locator_Name.equalsIgnoreCase("linktext")) 
		{
			...
			driver.findElement(By.linkText(Locator_Value)).sendKeys(Data);
		}
	}
	}
